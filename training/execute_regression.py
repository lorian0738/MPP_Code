...
""" File to store log"""
f = open('/home/development/apoorvan/AN_MTP/cikm/log/lrec_regression/TBart_VKey_' +
         filename+'.txt', 'a+')
        ...
        for batch_size in [64,128]:
            for shared_embedding_size, projection_embedding_size in zip([2048, 1024], [1024, 256]):
                ...
                for fold in range(5):
                    ...
                    """
                    train = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/val_aro_splits/train_' + str(fold)+'.csv')
                    valid = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/val_aro_splits/test_' + str(fold)+'.csv')
                    seed()
                ...
                stats.to_csv('/home/development/apoorvan/AN_MTP/cikm/stats/lrec_regression/TBart_Vkey_' +
                ...
                results.to_csv('/home/development/apoorvan/AN_MTP/cikm/predictions/lrec_regression/' + args.mode+'/' +

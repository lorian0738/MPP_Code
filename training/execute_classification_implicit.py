...
"""
        This script is used for hyper-parameter tuning and traininngg the model.
"""
...
# All features audio, Video and text saved in dictonary format
...
#                     ), '/home/development/apoorvan/AN_MTP/SER/saved_models/rough_saved_models/V_T_A_average_5FOLD_FOLD'+str(fold)+'_'+str(e)+'.pth')
    ...
    if save:
        best_model.to('cpu')
        torch.save(best_model.state_dict(), '/home/development/apoorvan/AN_MTP/cikm/saved_models/emotion/implicit' +
...
""" File to store log"""
f = open('/home/development/apoorvan/AN_MTP/cikm/log/aug_complete_implicit/an_aug_'+
         filename+'.txt', 'a+')
""" File to store charts of clf report"""
c = open('/home/development/apoorvan/AN_MTP/cikm/charts/aug_complete_implicit/an_aug_'+
         filename+'.txt', 'a+')
        ...
        for batch_size in [128, 64]:
            for shared_embedding_size, projection_embedding_size in zip([2048, 1024], [1024, 256]):
                ...
                for fold in range(5):
                    ...
                    """
                    train = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/splits_aug_mustard++/train_' + str(fold)+'.csv')
                    valid = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/splits_aug_mustard++/test_' + str(fold)+'.csv')
                    seed()
                ...
                stats.to_csv('/home/development/apoorvan/AN_MTP/cikm/stats/aug_complete_implicit/an_aug_'+
                ...
                results.to_csv('/home/development/apoorvan/AN_MTP/cikm/predictions/aug_complete_implicit/'+ args.mode+'/an_aug_' +

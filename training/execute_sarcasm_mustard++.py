...
mustard_input = pd.read_csv('/home/development/apoorvan/AN_MTP/cikm/data/final_datasets/mustard++_sarcasm_detection.csv', index_col=0)
...
def training(mod, criterion, optimizer, call, train_loader, valid_loader, fold, e=500, patience=5, report=False,save=True):
    ...
    if save:
        ...
        torch.save(best_model.state_dict(), '/home/development/apoorvan/AN_MTP/cikm/saved_models/sarc/' +
...
""" File to store log"""
f = open('/home/development/apoorvan/AN_MTP/cikm/log/sarcasm/an_lrec_' +
         filename+'.txt', 'a+')
""" File to store charts of clf report"""
c = open('/home/development/apoorvan/AN_MTP/cikm/charts/sarcasm/an_lrec_'+
         filename+'.txt', 'a+')
# f = open('/home/development/apoorvan/AN_MTP/cikm/rough/' +
#          filename+'_log.txt', 'w')
# csv = open('/home/development/apoorvan/AN_MTP/cikm/stats'+filename+'.csv', 'w')
...
for fold in range(5):
    """
        ...
        this is done in order to keep consistancey in different experiments (to deal with randomness)
    """
    train = pd.read_csv(
        '/home/development/apoorvan/AN_MTP/cikm/data/split_mustard_pp_sarcasm/train_' + str(fold)+'.csv')
    valid = pd.read_csv(
        '/home/development/apoorvan/AN_MTP/cikm/data/split_mustard_pp_sarcasm/test_' + str(fold)+'.csv')
    seed()
...
stats.to_csv('/home/development/apoorvan/AN_MTP/cikm/stats/sarcasm/an_lrec_' +
...
results.to_csv('/home/development/apoorvan/AN_MTP/cikm/predictions/sarcasm/' +args.mode+'/best_an_lrec_' +

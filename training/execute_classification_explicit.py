...
# Use the right pickle file based on which benchmark you intend to test
...
def get_model_and_parameters(args):
    ...
    """
    # Here we are sortng VTA in descending order, in order to have consistency in the model
...
""" File to store log"""
f = open('/home/development/apoorvan/AN_MTP/cikm/log/lrec_complete_explicit/an_lrec_' +
         filename+'.txt', 'w')
""" File to store charts of clf report"""
c = open('/home/development/apoorvan/AN_MTP/cikm/charts/lrec_complete_explicit/an_lrec_' +
         filename+'.txt', 'a+')
            ...
            for shared_embedding_size, projection_embedding_size in zip([2048, 1024], [1024, 256]):          
                ...
                for fold in range(5):
                    """
                        ...
                        we have made the stritified splits explicitly
                        this is done in order to keep consistancey in different experiments (to deal with randomness)
                    """
                    train = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/splits_final_mustard++/train_' + str(fold)+'.csv')
                    valid = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/splits_final_mustard++/test_' + str(fold)+'.csv')
                    seed()
                ...
                stats.to_csv('/home/development/apoorvan/AN_MTP/cikm/stats/lrec_complete_explicit/an_lrec_'+
                ...
                results.to_csv('/home/development/apoorvan/AN_MTP/cikm/predictions/lrec_complete_explicit/' + args.mode+'/an_lrec_' +
